...
namespace SIL.Machine.FiniteState
{
	...
	internal class NondeterministicFstTraversalInstance<TData, TOffset> : TraversalInstance<TData, TOffset> where TData : IAnnotatedData<TOffset>
	{
		...
		public override void CopyTo(TraversalInstance<TData, TOffset> other)
		{
			...
			otherNfst._mappings.AddRange(_mappings.Select(kvp => new KeyValuePair<Annotation<TOffset>, Annotation<TOffset>>(kvp.Key, outputMappings[kvp.Value])));
